...
const llmProviders = [
  {
    name: "OpenAI gpt-4o-mini (tool_call enabled)",
  ...
  {
    name: "OpenAI gpt-4o-mini (tool_call disabled)",
    apiKey: process.env.OPENAI_API_KEY_2,
    baseUrl: "https://api.openai.com/v1",
    model: "gpt-4o-mini",
    enableToolCall: false, // ツール呼び出しを有効化
  },
  // {
  //   name: "OpenRouter gpt-4o-mini paid (tool_call enabled)",
  ...
  // },
  // {
  //   name: "OpenRouter gpt-4o-mini paid (tool_call disabled)",
  //   apiKey: process.env.OPENROUTER_API_KEY,
  //   baseUrl: "https://openrouter.ai/api/v1",
  //   model: "openai/gpt-4o-mini",
  //   enableToolCall: false, // ツール呼び出しを有効化
